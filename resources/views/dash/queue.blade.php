...
<tr align="center">
	...
	<td>{{$queues_info["506"]["name"]}}<canvas id="c506"  width="200" height="200" ></canvas></td>
	<td>{{$queues_info["512"]["name"]}}<canvas id="c512"  width="200" height="200" ></canvas></td>
	<td>{{$queues_info["510"]["name"]}}<canvas id="c510"  width="200" height="200" ></canvas></td>
	<td>{{$queues_info["502"]["name"]}}<canvas id="c502"  width="200" height="200" ></canvas></td>
</tr>
</table>
<ul id="labeldraw">
